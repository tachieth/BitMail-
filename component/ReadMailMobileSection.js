...
export default function ReadMailMobileSection({ isOpen, onClose }) {
        ...
        <DrawerContent bg="bg">
          <DrawerBody>
            <Box w="100%">
              ...
              <Heading fontSize="18px" mt="20px" color="#ffffff">
              ...
              >
                ...
                <Text mt="20px" ml="20px" fontSize="10px" color="#bebebe">
                  Hey,
                  <br />
                  Since the last time we met, i have been working on the V2
                  roadmap. Nice to meet you! <br />
